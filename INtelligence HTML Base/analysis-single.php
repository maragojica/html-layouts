...
<main class="content-main story-single-page">		
		
		<section class="article-hero" style="background-image: url('./assets/img/featured-bg-blue.jpg');">
			<div class="container">
				<div class="article-hero-content">
					<div class="article-type text-white text-center">Analysis</div>
					<div class="article-category">
						<span class="badge-category">Lense Category</span>
					</div>				
					<h1 class="article-title text-white">This title can take enough space and on several lines nim ut officiis (single)</h1>					
				</div>
			</div>
		</section>
	...
	<section class="related-post section-padding-large pt-mv-0">
	    <div class="container">
			<div class="headline text-center justify-center">
				<h2>D H2 RELATED ANALYSIS</h2>
			</div>
			<div class="related-row hide-lg-only">
				<article class="card card-vertical bg-blue-light active">
					<div class="card-image">
						<a href="#"><img src="assets/img/article-img-blue.png" alt="image" width="254"></a>
					</div>
					<div class="card-body">
						<div class="card-author"><img src="assets/img/profile.png" alt="author" class="author-img" width="28"><span>by <b>Name Surname</b></span></div>
						<h3 class="card-title">
							<a href="#">H3 title can take enough space and use on several lines</a>
						</h3>						
					</div>
				</article>
				<article class="card card-vertical bg-blue-light active">
			...
			<div class="carousel owl-carousel related-post-carousel gap-3 show-lg-only">
						<div class="item card card-vertical bg-blue-light">
							<div class="post-featured">
								<article class="card card-horizontal bg-blue-light h-full">
									<div class="card-body">
										<div class="card-author d-flex align-items-center">
											<img src="assets/img/profile.png" alt="author" width="28" class="author-img rounded-circle me-2">
											<span>by <b>Name Surname</b></span>
										</div>
										<h3 class="card-title h2 mb-2">
											<a href="#" class="text-decoration-none text-dark">
											H3 ipsum posuere at diam quam viverra nulla suspendisse mi leo aliquet
											</a>
										</h3>										
									</div>
									...
									<div class="card-image">
										<a href="#" class="full-link">
											<img src="assets/img/article-img-blue.png" alt="Imagen descriptiva" class="img-fluid rounded-end">
										</a>
									</div>
								</article>
							</div>
