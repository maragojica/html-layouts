<?php include 'template-parts/layouts/header.php'; ?>
		...
		<section class="section-headline section-padding">
			<div class="container">
				<div class="headline text-center justify-center">
					<h1>Data tool (single)</h1>
				</div>
			</div>
		</section>
		
		<section class="article-hero-full-img">
			<img src="assets/img/data-tool-large.jpg" alt="Data tool hero image" class="img-fluid w-100">
		</section>
	...
	<section class="related-post section-padding-large pt-0">
	    <div class="container">
			<div class="headline text-center justify-center">
				<h2>D H2 RELATED DATA TOOLS</h2>
			</div>
			<div class="related-row data-tools-cards-last hide-lg-only">
				<article class="item card card-vertical bg-pink">
					<div class="card-image">
						<a href="#"><img src="assets/img/data-tool.jpg" alt="image" width="254"></a>
					</div>
					<div class="card-body">
						<div class="card-author"><img src="assets/img/profile.png" alt="author" class="author-img" width="46"></div>
						<h3 class="card-title">
						...
						<div class="card-cta"><a href="#">See data</a></div>
					</div>
				</article>
				<article class="item card card-vertical bg-pink">
					<div class="card-image">
			...
			<div class="carousel owl-carousel data-tools-cards-carousel gap-3 show-lg-only">
						<article class="item card card-vertical bg-pink">
							<div class="card-image">
								<a href="#"><img src="assets/img/data-tool.jpg" alt="image" width="254"></a>
							</div>
